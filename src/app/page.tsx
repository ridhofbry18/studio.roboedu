...
export default async function Page() {
  ...
  if (useDummyData && allSpotlights.length === 0) {
    news = [
      ...
      { id: "2", type: "System Update", title: "Pembaruan Sistem QC Hub v2.0", subtitle: "Kini fitur God Mode dan Data Dummy telah hadir untuk memudahkan pengecekan." },
